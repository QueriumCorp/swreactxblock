...
#HIDEME        frag.add_resource('<link rel="icon" href="/favicon.ico"/>','text/html','head')
#HIDEME        frag.add_resource('<meta name="viewport" content="width=device-width,initial-scale=1"/>','text/html','head')
#HIDEME        frag.add_resource('<meta name="theme-color" content="#000000"/>','text/html','head')
#HIDEME        frag.add_resource('<link rel="apple-touch-icon" href="/logo192.png"/>','text/html','head')
...
#HIDEME        frag.add_css_url("//fonts.googleapis.com/css?family=Open+Sans:400,700")
#HIDEME        frag.add_css_url("//fonts.googleapis.com/css?family=Oswald")
#HIDEME        frag.add_javascript_url("//cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.1/MathJax.js?config=TeX-MML-AM_HTMLorMML")
#HIDEME        frag.add_resource('<script type="text/x-mathjax-config">MathJax.Hub.Config({ messageStyle: \'none\', skipStartupTypeset: true, showMathMenu: true, tex2jax: { preview: \'none\' }, asciimath2jax: { delimiters: [[\'`\',\'`\'],[\'``\',\'``\']], preview: "none" }, AsciiMath: {displaystyle: false} }); MathJax.Hub.Register.LoadHook("[MathJax]/extensions/asciimath2jax.js",function () { var AM = MathJax.Extension.asciimath2jax, CREATEPATTERNS = AM.createPatterns; AM.createPatterns = function () { var result = CREATEPATTERNS.call(this); this.match[\'``\'].mode = ";mode=display"; return result; }; }); MathJax.Hub.Register.StartupHook("AsciiMath Jax Ready",function () { var AM = MathJax.InputJax.AsciiMath; AM.postfilterHooks.Add(function (data) { if (data.script.type.match(/;mode=display/)) {data.math.root.display = "block"} return data; }); });</script>','text/html','head')
#HIDEME        frag.add_resource('<script type="text/javascript">function getInternetExplorerVersion(){var e=-1;if("Microsoft Internet Explorer"==navigator.appName){var r=navigator.userAgent;null!=new RegExp("MSIE ([0-9]{1,}[.0-9]{0,})").exec(r)&&(e=parseFloat(RegExp.$1))}return e}var ieVer=getInternetExplorerVersion();2<ieVer&&ieVer<10&&(alert("Sorry, you are using an obsolete version of Internet Explorer. Querium has been designed for the secure, modern web.  Querium joins Microsoft in encouraging you to upgrade to Internet Explorer 10 or 11."),window.open("http://blogs.msdn.com/b/ie/archive/2014/08/07/stay-up-to-date-with-internet-explorer.aspx","_self"))</script>','text/html','head')
#HIDEME        frag.add_css_url("//code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css")

#HIDEME        frag.add_css_url("//fonts.googleapis.com/css?family=Lato")
#HIDEME        frag.add_css_url("//fonts.googleapis.com/css?family=Oswald")
...
#HIDEME        frag.add_css_url("//stepwise.querium.com/libs/mathquill/mathquill.css")
#HIDEME        frag.add_css_url("//cdn.jsdelivr.net/gh/mlaursen/react-md@5.1.4/themes/react-md.teal-pink-200-light.min.css")
#HIDEME        frag.add_css_url("//stepwiseai.querium.com/client/querium-stepwise-1.6.8.css")
#HIDEME        frag.add_javascript_url("//www.gstatic.com/firebasejs/4.4.0/firebase.js")               # For qEval client-side logging
#HIDEME        frag.add_javascript_url("//ajax.googleapis.com/ajax/libs/angularjs/1.5.3/angular.min.js")
#HIDEME        frag.add_javascript_url("//ajax.googleapis.com/ajax/libs/angularjs/1.5.3/angular-sanitize.min.js")
#HIDEME        frag.add_javascript_url("//ajax.googleapis.com/ajax/libs/angularjs/1.5.3/angular-animate.min.js")
#HIDEME        frag.add_javascript_url("//stepwiseai.querium.com/client/querium-stepwise-1.6.8.1-jira.js")
#HIDEME        frag.add_content('<script>querium.qEvalLogging=!0</script>')

#HIDEME        frag.add_css(self.resource_string("static/css/swpwrxstudent.css"))
...
#HIDEME        frag.add_javascript(self.resource_string("static/js/src/swpwrxstudent.js"))
#HIDEME        frag.add_resource('<base href="/testq_assets/"/>','text/html','head')		# Needed so react code can find its pages. Don't do earlier or impacts relative pathnames of resources
