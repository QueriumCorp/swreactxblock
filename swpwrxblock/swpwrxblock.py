...
class SWPWRXBlock(StudioEditableXBlockMixin, ScorableXBlockMixin, XBlock):
    ...
    display_name = String(display_name="Display name", default='SWPWR', scope=Scope.content)
    ...
    q_stimulus = String(help="SWPWR Stimulus", default='Solve for \\(a\\).', scope=Scope.content)
    ...
    q2_id = String(help="SWPWR Question ID", default="", scope=Scope.content)
    q2_label = String(help="SWPWR Question Alternate 2", default="", scope=Scope.content)
    q2_stimulus = String(help="SWPWR Stimulus", default='', scope=Scope.content)
    q2_definition = String(help="SWPWR Definition", default='', scope=Scope.content)
    q2_type = String(help="SWPWR Type", default='gradeBasicAlgebra', scope=Scope.content)
    q2_display_math = String(help="SWPWR Display Math", default='\\(\\)', scope=Scope.content)
    q2_hint1 = String(help="SWPWR First Hint", default='', scope=Scope.content)
    q2_hint2 = String(help="SWPWR Second Hint", default='', scope=Scope.content)
    q2_hint3 = String(help="SWPWR Third Hint", default='', scope=Scope.content)

    q3_id = String(help="SWPWR Question ID", default="", scope=Scope.content)
    q3_label = String(help="SWPWR Question Alternate 3", default="", scope=Scope.content)
    q3_stimulus = String(help="SWPWR Stimulus", default='', scope=Scope.content)
    q3_definition = String(help="SWPWR Definition", default='', scope=Scope.content)
    q3_type = String(help="SWPWR Type", default='gradeBasicAlgebra', scope=Scope.content)
    q3_display_math = String(help="SWPWR Display Math", default='\\(\\)', scope=Scope.content)
    q3_hint1 = String(help="SWPWR First Hint", default='', scope=Scope.content)
    q3_hint2 = String(help="SWPWR Second Hint", default='', scope=Scope.content)
    q3_hint3 = String(help="SWPWR Third Hint", default='', scope=Scope.content)

    q4_id = String(help="SWPWR Question ID", default="", scope=Scope.content)
    q4_label = String(help="SWPWR Question Alternate 4", default="", scope=Scope.content)
    q4_stimulus = String(help="SWPWR Stimulus", default='', scope=Scope.content)
    q4_definition = String(help="SWPWR Definition", default='', scope=Scope.content)
    q4_type = String(help="SWPWR Type", default='gradeBasicAlgebra', scope=Scope.content)
    q4_display_math = String(help="SWPWR Display Math", default='\\(\\)', scope=Scope.content)
    q4_hint1 = String(help="SWPWR First Hint", default='', scope=Scope.content)
    q4_hint2 = String(help="SWPWR Second Hint", default='', scope=Scope.content)
    q4_hint3 = String(help="SWPWR Third Hint", default='', scope=Scope.content)

    q5_id = String(help="SWPWR Question ID", default="", scope=Scope.content)
    q5_label = String(help="SWPWR Question Alternate 5", default="", scope=Scope.content)
    q5_stimulus = String(help="SWPWR Stimulus", default='', scope=Scope.content)
    q5_definition = String(help="SWPWR Definition", default='', scope=Scope.content)
    q5_type = String(help="SWPWR Type", default='gradeBasicAlgebra', scope=Scope.content)
    q5_display_math = String(help="SWPWR Display Math", default='\\(\\)', scope=Scope.content)
    q5_hint1 = String(help="SWPWR First Hint", default='', scope=Scope.content)
    q5_hint2 = String(help="SWPWR Second Hint", default='', scope=Scope.content)
    q5_hint3 = String(help="SWPWR Third Hint", default='', scope=Scope.content)

    q6_id = String(help="SWPWR Question ID", default="", scope=Scope.content)
    q6_label = String(help="SWPWR Question Alternate 6", default="", scope=Scope.content)
    q6_stimulus = String(help="SWPWR Stimulus", default='', scope=Scope.content)
    q6_definition = String(help="SWPWR Definition", default='', scope=Scope.content)
    q6_type = String(help="SWPWR Type", default='gradeBasicAlgebra', scope=Scope.content)
    q6_display_math = String(help="SWPWR Display Math", default='\\(\\)', scope=Scope.content)
    q6_hint1 = String(help="SWPWR First Hint", default='', scope=Scope.content)
    q6_hint2 = String(help="SWPWR Second Hint", default='', scope=Scope.content)
    q6_hint3 = String(help="SWPWR Third Hint", default='', scope=Scope.content)

    q7_id = String(help="SWPWR Question ID", default="", scope=Scope.content)
    q7_label = String(help="SWPWR Question Alternate 7", default="", scope=Scope.content)
    q7_stimulus = String(help="SWPWR Stimulus", default='', scope=Scope.content)
    q7_definition = String(help="SWPWR Definition", default='', scope=Scope.content)
    q7_type = String(help="SWPWR Type", default='gradeBasicAlgebra', scope=Scope.content)
    q7_display_math = String(help="SWPWR Display Math", default='\\(\\)', scope=Scope.content)
    q7_hint1 = String(help="SWPWR First Hint", default='', scope=Scope.content)
    q7_hint2 = String(help="SWPWR Second Hint", default='', scope=Scope.content)
    q7_hint3 = String(help="SWPWR Third Hint", default='', scope=Scope.content)

    q8_id = String(help="SWPWR Question ID", default="", scope=Scope.content)
    q8_label = String(help="SWPWR Question Alternate 8", default="", scope=Scope.content)
    q8_stimulus = String(help="SWPWR Stimulus", default='', scope=Scope.content)
    q8_definition = String(help="SWPWR Definition", default='', scope=Scope.content)
    q8_type = String(help="SWPWR Type", default='gradeBasicAlgebra', scope=Scope.content)
    q8_display_math = String(help="SWPWR Display Math", default='\\(\\)', scope=Scope.content)
    q8_hint1 = String(help="SWPWR First Hint", default='', scope=Scope.content)
    q8_hint2 = String(help="SWPWR Second Hint", default='', scope=Scope.content)
    q8_hint3 = String(help="SWPWR Third Hint", default='', scope=Scope.content)

    q9_id = String(help="SWPWR Question ID", default="", scope=Scope.content)
    q9_label = String(help="SWPWR Question Alternate 9", default="", scope=Scope.content)
    q9_stimulus = String(help="SWPWR Stimulus", default='', scope=Scope.content)
    q9_definition = String(help="SWPWR Definition", default='', scope=Scope.content)
    q9_type = String(help="SWPWR Type", default='gradeBasicAlgebra', scope=Scope.content)
    q9_display_math = String(help="SWPWR Display Math", default='\\(\\)', scope=Scope.content)
    q9_hint1 = String(help="SWPWR First Hint", default='', scope=Scope.content)
    q9_hint2 = String(help="SWPWR Second Hint", default='', scope=Scope.content)
    q9_hint3 = String(help="SWPWR Third Hint", default='', scope=Scope.content)
