...
# Now we can finally add the React app bundle assets
        ...
        javascripts_string = '      window.swpwr_problem = `'+json_string+'`;'
        if DEBUG: logger.info("SWPWRXBlock student_view() swpwr_problem final json={j}".format(j=javascript_string))
