...
function SWPWRXStudent(runtime, element) {
    ...
    // Don't show the React div or hide the problem complete msg for now
    ...
    $.ajax({
        ...
        success: function (data,msg) {
            ...
            // function previewClicked(){
                ...
                // console.info("SWPWRXstudent previewClicked() started");
                // console.info("SWPWRXstudent previewClicked() count_attempts ",count_attempts);
                // console.info("SWPWRXstudent previewClicked() max_attempts ",max_attempts);
                // console.info("SWPWRXstudent previewClicked() weight ",weight);
                // console.info("SWPWRXstudent previewClicked() min_steps ",min_steps);
                // console.info("SWPWRXstudent previewClicked() min_steps_ded ",min_steps_ded);
                // Don't let student launch question if they've exceeded the limit on question attempts
                // if (max_attempts != -1 && count_attempts >= max_attempts) {
                //     console.info("SWPWRXstudent previewClicked() too many attempts");
                //     $('.click-to-begin').hide();
                //     $('.too-many-attempts').show();
                //     $('.too-many-attempts').onclick = null;
                //     $('.retry').hide();
                ...
                //     options.policies = '$A5$';
                // };
                // console.info("SWPWRXstudent previewClicked() options.policies set to",options.policies);

                // function celebrate(stats) {
                    // swpwrxblock_block.classList.remove("block_working");
                    // swpwrxblock_block.classList.add("block_worked");
                ...
                // function start_attempt(status) {
                    ...
                    //     success: function (data) {
                    //       console.info("SWPWRXstudent start_attempt POST success");
                    //       start_attempt_obj = JSON.parse(data);
                    //       count_attempts = start_attempt_obj.count_attempts;
                    //       update_grade_attempts_data();
                    //       console.info("SWPWRXstudent start_attempt POST response count_attempts=",count_attempts);
                    //   }
                    // });
                // }
                ...
                // swpwrxblock_block.classList.add("block_working");
                // swpwrxblock_block.classList.remove("block_worked");
                // setTimeout( function(){
                //     swpwrxblock_block.scrollIntoView({ behavior:"smooth"});
                // }, 250);

                // console.info("SWPWRXblock previewClicked() calling querium.startQuestion with options ",options);
                // querium.startQuestion( 'OpenStaxHomework', sId, qDef, callbacks, options, stepwise_element );    // launch!

            // }

            // function retryClicked(){
            //     console.info("SWPWRXstudent retryClicked() started");
            //     $.ajax({
            //         type: "POST",
            //         url: handlerUrlRetry,
            //         // data: JSON.stringify(),
            ...
            //             console.info("SWPWRXstudent retry POST success");
            //             console.info("SWPWRXstudent retry POST data",data);
            //             console.info("SWPWRXstudent retry POST msg",msg);
            //         }
            //     });
            //     console.info("SWPWRXstudent retryClicked() ended");
            // }

            // // NOT USED AT PRESENT
            // //success Type: Function( PlainObject data, String textStatus, jqXHR jqXHR )
            // function retrySuccess(data, textstatus, jqXHR) {
            //     console.info("SWPWRXstudent retrySuccess() started");
            //     console.info("SWPWRXstudent retrySuccess() data",data);
            //     console.info("SWPWRXstudent retrySuccess() textStatus",textStatus);
            //     console.info("SWPWRXstudent retrySuccess() jqXHR",jqXHR);
            //     console.info("SWPWRXstudent retrySuccess() ended");
            // }
